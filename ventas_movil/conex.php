...
function Conectarse()
{
   ...
   if (!mysqli_query( $link, $set_local))	
   {
	...
	mysqli_query($link, "SET NAMES 'utf8'") or die("Error Cambiando charset").mysqli_error();
	
	setlocale(LC_ALL,"es_ES");
	mysqli_query($link, "SET CHARACTER SET utf8") or die("Error en charset UTF8".mysqli_error());
