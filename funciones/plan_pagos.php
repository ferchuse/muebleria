<?php foreach($ventas AS $index => $fila_venta){ ?>
			...
			<table class="table table-bordered table-condensed">
				...
				<tfoot>	
					<tr class="bg-secondary text-light">
						<td colspan="3" ></td>
						<td >
							<?php echo "Pagos Atrasados: $atrasados";?><br>
							<?php echo "Intereses Acumulados: $suma_intereses";?> <br>
							<?php echo "Periodos Vencidos: $periodos_vencidos";?>
						</td>
					</tr>
				</tfoot>
			</table>
